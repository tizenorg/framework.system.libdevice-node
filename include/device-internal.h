...
#define OEM_SYS(node)		plugin_intf->OEM_sys_##node
#define OEM_GET(node)		plugin_intf->OEM_sys_get_##node
#define OEM_SET(node)		plugin_intf->OEM_sys_set_##node

#define PLUGIN_SYS(node)	(OEM_SYS(node) ? OEM_SYS(node) : DEF_SYS(node))
#define PLUGIN_GET(node)	(OEM_GET(node) ? OEM_GET(node) : DEF_GET(node))
#define PLUGIN_SET(node)	(OEM_SET(node) ? OEM_SET(node) : DEF_SET(node))
