...
enum device_type
{
	...
	DEVICE_TYPE_THERMISTOR,         /**< thermistor */
	DEVICE_TYPE_TOUCH,              /**< touch */
	DEVICE_TYPE_HALL,               /**< hall */
	DEVICE_TYPE_MAX,
};
...
enum {
	...
	PROP_DISPLAY_IMAGE_ENHANCE_COLOR_BLIND,
	PROP_DISPLAY_AUTO_SCREEN_TONE,
	PROP_DISPLAY_HBM_CONTROL,
	PROP_DISPLAY_ELVSS_CONTROL,
	PROP_DISPLAY_AUTO_SCREEN_TONE_FORCE,
};
...
enum {
	...
	PROP_POWER_LOCK,
	PROP_POWER_LOCK_SUPPORT,
	PROP_POWER_PRESENT,
	PROP_POWER_HEALTH,                      /**< Battery status about cahrge */
	PROP_POWER_INSUSPEND_CHARGING_SUPPORT,
	PROP_POWER_SIOP_ACTIVE,
	PROP_POWER_SIOP_CONTROL,
	PROP_POWER_RESETKEY_DISABLE,
	PROP_POWER_TECHNOLOGY,                  /**< Battery technology */
	PROP_POWER_TEMPERATURE,                 /**< Battery temperature */
	PROP_POWER_VOLTAGE,                     /**< Battery voltage */
	PROP_POWER_SIOP_LEVEL,
	PROP_POWER_REAR_LEVEL,
	PROP_POWER_WAKEUP_KEY,
};
...
enum {
	...
	PROP_CPU_POWER_MAX_FREQ,
	PROP_CPU_POWER_MIN_FREQ,
	PROP_CPU_ENABLE_MAX_NUMBER,
	PROP_CPU_ID_MIN_FREQ,
	PROP_CPU_ID_MAX_FREQ,
	PROP_CPU_FIXED_NUMBER,
	PROP_CPU_PM_SCENARIO,
};
...
/**
 * @par Description:
 * 	DEVICE_TYPE_THERMISTOR property for generic APIs
 */
enum {
	PROP_THERMISTOR_ADC,
	PROP_THERMISTOR_VALUE,
};

/**
 * @par Description:
 * 	DEVICE_TYPE_TOUCH property for generic APIs
 */
enum {
	PROP_TOUCH_SCREEN_FLIP_MODE,
	PROP_TOUCH_SCREEN_GLOVE_MODE,
	PROP_TOUCH_KEY_FLIP_MODE,
	PROP_TOUCH_KEY_GLOVE_MODE,
};

/**
 * @par Description:
 * DEVICE_TYPE_HALL property for generic APIs
 */
enum {
	PROP_HALL_STATUS,
};
